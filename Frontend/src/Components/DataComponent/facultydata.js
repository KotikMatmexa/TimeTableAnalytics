            ...
            <div className="data--section">
                <div className="data--table">
                    <div className="data--header">
                        ...
                        <select
                            onChange={e => this.loadAudiences(e, this.props.facultyData)}
                        >
                            {Object.values(
                                this.props.facultyData.locationWithEventsDto.results
                            ).map(cabinet => (
                                <option key={cabinet.location.oid}>
                                    {cabinet.location.number_actual}
                                </option>
                            ))}
                        </select>
                    </div>
