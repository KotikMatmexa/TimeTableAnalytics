        ...
        return (
            <>
                <div className="day--component">
                    ...
                    <span>
            {new Date(this.props.day.day).getDate()}.
                        {new Date(this.props.day.day).getMonth() + 1}
          </span>

                    <div className="day--timetable">
                        {this.props.day.data.length == 0 ? (
                            <span>
                Кабинет полностью свободен на выбранный промежуток времени
              </span>
                        ) : (
                            <ul>
